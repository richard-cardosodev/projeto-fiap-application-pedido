...
@Service
public class PagamentoCanceladoQueueIN implements IPagamentoConfirmadoQueueIN {
    ...
    public PagamentoCanceladoQueueIN(IJsonConverter jsonConverter, IPedidoPagamentoIntegrationRestAdapterController pedidoPagamentoIntegrationRestAdapterController) {
        this.jsonConverter = jsonConverter;
        this.pedidoPagamentoIntegrationRestAdapterController = pedidoPagamentoIntegrationRestAdapterController;
    }

    @Transactional
    @RabbitListener(queues = {"${pagamento.cancelado.queue}"})
    @Override
    public void receive(String message) {
        try {
            ...
            logger.info("Processando retorno pagamento cancelado");
        } catch (Exception e) {
